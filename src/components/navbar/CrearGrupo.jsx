        ...
        <div className="flex items-center">
          <div
            className={`w-8 h-8 rounded-full flex items-center justify-center ${
              paso === 1 ? "bg-[#64c27b] text-white" : "bg-white text-[#64c27b]"
            }`}
          >
            1
          </div>
          ...
          <div
            className={`w-8 h-8 rounded-full flex items-center justify-center ${
              paso === 2 ? "bg-[#64c27b] text-white" : "bg-white text-[#64c27b]"
            }`}
          >
            2
          </div>
          ...
          <div
            className={`w-8 h-8 rounded-full flex items-center justify-center ${
              paso === 3 ? "bg-[#64c27b] text-white" : "bg-white text-[#64c27b]"
            }`}
          >
            3
          </div>
          ...
          <div
            className={`w-8 h-8 rounded-full flex items-center justify-center ${
              paso === 4 ? "bg-[#64c27b] text-white" : "bg-white text-[#64c27b]"
            }`}
          >
            4
          </div>
